            ...
            <div class="nano-content">
                <ul>
                    <div class="logo"><a href="index.html">
                            <!-- <img src="assets/images/logo.png" alt="" /> --><span><?php echo $objResult["Username"]; ?></span></a></div>
                    <!--   
                    ...
                    <li><a href="edit_profile.php"><i class="ti-user"></i> แก้ไขข้อมูลส่วนตัว </a></li>
                    ...
                    <li><a class="sidebar-sub-toggle"><i class="ti-bar-chart-alt"></i> งานซ่อมบำรุง <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                        ...
                        <ul>
                            <li><a href="   ">ติดตามสถานะการแจ้งซ่อม</a></li>
                        </ul>
                    </li>
