                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>งามซ่อมที่ดำเนินการเสร็จสิ้น <span></span></h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                                    ...
                                    <div class="table-responsive">
                                        <div class="col-lg-7">
                                            <div class="row">
                                                ...
                                                <a href="pdf_report_complete.php<?php echo ((isset($_GET['startDate']) && isset($_GET['endDate'])) ? '?startDate='.$_GET['startDate'].'&endDate='.$_GET['endDate'] : ''); ?>">
...
$(function() {
    ...
    window.location.href = `http://localhost:8000/admin_report_complete.php?startDate=${start.format('YYYY-MM-DD')}&endDate=${end.format('YYYY-MM-DD')}`
  });
});
</script>
</html>