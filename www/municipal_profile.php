...
if ($_SESSION['member_typeid'] != 3) {
    echo "This page for Municiple only!";
    exit();
}
                            ...
                            <div class="drop-down dropdown-profile">
                                <div class="dropdown-content-body">
                                    <ul>
                                        ...
                                        <li><a href="edit_profile2.php"><i class="ti-pencil"></i> <span>แก้ไขข้อมูลส่วนตัว</span></a></li>
                                ...
                                <div class="card-body">
                                    <div class="user-profile">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="user-profile-name"> <?php echo $objResult["member_email"]; ?> </div>
                                                        ...
                                                        <div role="tabpanel" class="tab-pane active" id="1">
                                                            <div class="contact-information">
                                                                ...
                                                                <div class="gender-content">
                                                                    ...
                                                                    <?php echo $objResult["member_lname"]; ?>
                                                                </div>
                                                                <div class="gender-content">
                                                                    <span class="contact-title">เพศ :</span>
                                                                    <?php echo $objResult["member_gender"]; ?>
                                                                </div>
                                                                <div class="gender-content">
                                                                    <span class="contact-title">วันเกิด :</span>
                                                                    <?php echo $objResult["member_birthdate"]; ?>
                                                                </div>
                                                                <div class="gender-content">
                                                                    <span class="contact-title">อายุ :</span>
                                                                    <?php echo $objResult["member_age"]; ?>
                                                                </div>
                                                                <div class="gender-content">
                                                                    <span class="contact-title">หมายเลขบัตรประชาชน :</span>
                                                                    <?php echo $objResult["member_id_card"]; ?>
                                                                </div>
                                                                <div class="gender-content">
                                                                    <span class="contact-title">ที่อยู่ :</span>
                                                                    <?php echo $objResult["member_address"]; ?>
                                                                </div>
