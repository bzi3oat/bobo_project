    ...
    <div class="main">
      <div class="container-fluid">
        ...
        <section id="main-content">
          <form action="insert_electricity.php" method="post" name="form1">
            <div class="row">
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-body">
                                ...
                                <div class="row">
                                  <div class="col-lg-12">
                                    ...
                                    <div class="input-field col l2">
                                      <label for="icon_telephone"> ตำแหน่งเสาไฟฟ้า : </label>
                                    </div>
                                    <div class="input-field col l2">
                                      <input id="latinput" type="text" name="lat" required />
                                      <label for="icon_telephone"> </label>
                                    </div>
                                    <div class="input-field col l2">
                                      <input id="lnginput" type="text" name="lng" required />
                                      <label for="icon_telephone"> </label>
                                    </div>
