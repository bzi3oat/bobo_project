    ...
    <div class="content-wrap">
        <div class="main">
            <div class="container-fluid">
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>เพิ่มข้อมูลประเภทยี่ห้อสินค้า <span> </span></h1>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form action="api_insertbrand.php" method="post" name="form1">
                    <div class="card">
                        <div class="card-title">
                            <h6>กรุณากรอกข้อมูลประเภทยี่ห้อสินค้า</h6>
                            <div class="row" style="margin-bottom:0px;">
                                <div class="col-lg-12">
                                    <div class="input-field col s12">
                                        <i class="material-icons prefix">account_circle</i>
                                        <input class="fname" type="text" name="brand_name" required />
                                        <label for="icon_prefix">ชื่อยี่ห้อ</label>
                                    </div>
                                </div>
                            </div>
                          
                            <a href="admin_electricity_lamp.php">
